...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрЦех 		= КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек,"Цех");
	ЗначениеПараметра 	= ПараметрЦех.Значение;
	
	Если ТипЗнч(ЗначениеПараметра) <> Тип("СписокЗначений") И ТипЗнч(ЗначениеПараметра) <> Тип("СправочникСсылка.СтруктурныеЕдиницы") Тогда
		ПустойСписок = Истина;
	Иначе
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПустойСписок",ПустойСписок);
